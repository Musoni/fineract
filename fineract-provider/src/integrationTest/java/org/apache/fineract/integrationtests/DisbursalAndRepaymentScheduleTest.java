...
public class DisbursalAndRepaymentScheduleTest {
    ...
    private final SimpleDateFormat dateFormatterFineractStandard = new SimpleDateFormat("dd MMMM yyyy");
    ...
    public void testRescheduleJLGLoanSynk() {
        ...
        final String groupMeetingDate = this.dateFormatterFineractStandard.format(meetingCalendar.getTime());

        final String disbursalDate = groupMeetingDate; // first meeting date
        // after group creation

        final String rescheduleSubmittedDate = this.dateFormatterFineractStandard.format(new java.util.Date());

        final String loanType = "jlg";
        final String rescheduleInterestRate = "28.0";
        groupMeetingChangeCalendar.add(Calendar.DAY_OF_YEAR, 1);
        final String groupMeetingNewStartDate = this.dateFormatterFineractStandard.format(groupMeetingChangeCalendar.getTime());
        // The date
        // from
        // which we
        // start the
        ...
        final String rescheduleDate = this.dateFormatterFineractStandard.format(groupMeetingChangeCalendar.getTime());
