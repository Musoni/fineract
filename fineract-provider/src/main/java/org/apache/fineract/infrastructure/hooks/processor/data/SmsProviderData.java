...
public class SmsProviderData {
	...
	public String getFineractToken() {
		return fineractToken;
	}

	public void setFineractToken(String fineractToken) {
		this.fineractToken = fineractToken;
	}
