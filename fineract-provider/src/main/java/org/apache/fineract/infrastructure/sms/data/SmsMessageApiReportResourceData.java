...
public class SmsMessageApiReportResourceData {
	 ...
	 **/
	private SmsMessageApiReportResourceData(List<Long> externalIds, String fineractTenantIdentifier) {
	 ...
	 **/
	public static final SmsMessageApiReportResourceData instance(List<Long> externalIds, String fineractTenantIdentifier) {
		return new SmsMessageApiReportResourceData(externalIds, fineractTenantIdentifier);
	}
