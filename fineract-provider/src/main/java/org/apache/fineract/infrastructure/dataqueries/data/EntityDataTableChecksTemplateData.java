...
public class EntityDataTableChecksTemplateData implements Serializable {
    ...
    private final Collection<LoanProductData> loanProductDatas;
     ...
     public EntityDataTableChecksTemplateData(final List<String> entities, List<DatatableCheckStatusData> status,List<DatatableChecksData> datatables, Collection<LoanProductData> loanProductDatas) {
