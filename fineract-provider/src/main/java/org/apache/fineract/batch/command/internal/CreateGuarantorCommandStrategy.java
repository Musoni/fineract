 ...
 */
@Component
public class CreateGuarantorCommandStrategy implements CommandStrategy {

    private final GuarantorsApiResource guarantorsApiResource;

    @Autowired
    public CreateGuarantorCommandStrategy(GuarantorsApiResource guarantorsApiResource) {
    ...
    public BatchResponse execute(BatchRequest batchRequest, UriInfo uriInfo) {
        ...
        try {
            ...
            responseBody = guarantorsApiResource.createGuarantor(loanId, batchRequest.getBody());
