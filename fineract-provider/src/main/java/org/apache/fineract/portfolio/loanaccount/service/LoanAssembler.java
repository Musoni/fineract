...
import org.apache.fineract.portfolio.charge.exception.ChargeCannotBeOverriddenException;
...
import org.apache.fineract.portfolio.loanaccount.exception.StandingInstructionNotAllowedException;
    ...
    private Loan assembleApplication(final JsonElement element, final Long clientId, final Long groupId, final AppUser currentUser) {
        ...
        if (client != null && group != null) {
            ...
            loanApplication = Loan.newIndividualLoanApplication(accountNo, client, loanType.getId().intValue(), loanProduct, fund,
                    ...
                    isFloatingInterestRate, interestRateDifferential, null);
