...
public class LoanRescheduleRequestReadPlatformServiceImpl implements LoanRescheduleRequestReadPlatformService {
    ...
    @Autowired
    public LoanRescheduleRequestReadPlatformServiceImpl(final RoutingDataSource dataSource, final LoanRepositoryWrapper loanRepositoryWrapper,
    ...
    private static final class LoanRescheduleRequestRowMapper implements RowMapper<LoanRescheduleRequestData> {
        ...
        public LoanRescheduleRequestRowMapper() {
            ...
            sqlBuilder.append("cv.code_value as rescheduleReasonCvValue, cv.is_active as rescheduleReasonIsActive, ");
        ...
        public LoanRescheduleRequestData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            final boolean rescheduleReasonIsActive = rs.getBoolean("rescheduleReasonIsActive");
            final CodeValueData rescheduleReasonCodeValue = CodeValueData.instance(rescheduleReasonCvId, 
                    rescheduleReasonCvValue, rescheduleReasonIsActive);
