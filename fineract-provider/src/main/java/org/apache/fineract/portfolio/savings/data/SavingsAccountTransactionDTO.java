...
public class SavingsAccountTransactionDTO {
    ...
    private final boolean isGuarantorInterestDeposit;
    ...
    public SavingsAccountTransactionDTO(final DateTimeFormatter formatter, final LocalDate transactionDate,
        ...
        this.isGuarantorInterestDeposit = isGuarantorInterestDeposit;
    }
    ...
    public SavingsAccountTransactionDTO(DateTimeFormatter formatter, LocalDate transactionDate, BigDecimal transactionAmount,
            PaymentDetail paymentDetail, Date createdDate, Long savingsAccountId, AppUser appUser,boolean isGuarantorInterestDeposit) {
        this.formatter = formatter;
        this.transactionDate = transactionDate;
        this.transactionAmount = transactionAmount;
        this.paymentDetail = paymentDetail;
    ...
    public boolean isGuarantorInterestDeposit() {return this.isGuarantorInterestDeposit;}
}
