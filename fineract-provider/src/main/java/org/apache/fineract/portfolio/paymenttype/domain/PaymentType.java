...
@Entity
@Table(name = "m_payment_type", uniqueConstraints = { @UniqueConstraint(columnNames = { "value" }, name = "unique_payment_type") })
public class PaymentType extends AbstractPersistableCustom<Long> {
    ...
    public void delete() {
        ...
        // append "_deleted_" string and the id of the entity to the name
