...
public class Loan extends AbstractPersistableCustom<Long> {
    ...
    public ChangedTransactionDetail waiveLoanCharge(final LoanCharge loanCharge, final LoanLifecycleStateMachine loanLifecycleStateMachine,
        ...
        if (loanCharge.isDueDateCharge() || loanCharge.isPenaltyCharge()) {
    ...
    public Map<String, Object> loanApplicationModification(final JsonCommand command, final Set<LoanCharge> possiblyModifedLoanCharges,
            ...
            final Set<GroupLoanMemberAllocation> possiblyModifiedGroupLoanMembersAllocation, final LoanProduct loanProduct) {
    ...
    /**
     * Behaviour added to comply with capability of previous fineract product to
    ...
    private void updateLoanOutstandingBalaces() {
        ...
        for (LoanTransaction loanTransaction : loanTransactions) {
            if (loanTransaction.isDisbursement() || loanTransaction.isRefundForActiveLoan() 
